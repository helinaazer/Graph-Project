...
// tests the add, connect, disconnect, contains, verticesSize, edgeSize,
// vertexDegree, getEdgesAsString
void testGraphBasic() {
  Graph g;
...
// tests the Dijkstra's algorithm
...
// tests whether the graph is directed or not
...
// tests dfs, bfs, prim's, and dijkstra's using graph1
void testGraph1() {
